...
export default function Index() {
  ...
  const handleSearch = async () => {
    try {
      const response = await fetch(`https://192.168.0.12:3535/pacientes?nome=${codigoPaciente}`); //Conexão com o BackEnd para fazer uma busca se existe o código do paciente inserido na home
      if (response.ok) {
